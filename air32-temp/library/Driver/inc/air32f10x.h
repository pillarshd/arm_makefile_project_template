 ...
 * @brief In the following line adjust the External High Speed oscillator (HSE) Startup 
   Timeout value 
   */
#define HSE_STARTUP_TIMEOUT   ((uint16_t)0x0F00) /*!< Time out for HSE start up */
 ...
 */
#define __MPU_PRESENT             0 /*!< air32 devices provide an MPU */
...
/******  air32 specific Interrupt Numbers *********************************************************/
...
typedef struct
{
	__IO uint32_t SYSCFG_LOCK;
	__IO uint32_t SYSCFG_RSVD0[(0xC0-0x04) >> 2];
	__IO uint32_t SENSOR_EN;
	__IO uint32_t SENSOR_STAT;
	__IO uint32_t SEN_VG_DETECT;
	__IO uint32_t SSC_CLK_EN;
	__IO uint32_t SENSOR_ACTION;
	__IO uint32_t SYSCFG_RSVD2;
	__IO uint32_t SYSCFG_RSVD3;
	__IO uint32_t SYSCFG_RSVD4;
	__IO uint32_t SENSOR_STAT_FLG;
	__IO uint32_t SENSOR_INT_FLG;
}SYSCFG_TypeDef;
...
#define SYSCFG_BASE           (APB2PERIPH_BASE + 0x6C00)
#define OTP_BASE			  (APB2PERIPH_BASE + 0x6C50)
...
#define TRNG_BASE             (AHBPERIPH_BASE + 0x10040800)
...
#define  RCC_CFGR_PLLMULL17                 ((uint32_t)0x10000000)        /*!< PLL input clock*11 */
#define  RCC_CFGR_PLLMULL18                 ((uint32_t)0x10040000)        /*!< PLL input clock*12 */
#define  RCC_CFGR_PLLMULL19                 ((uint32_t)0x10080000)        /*!< PLL input clock*13 */
#define  RCC_CFGR_PLLMULL20                 ((uint32_t)0x100C0000)        /*!< PLL input clock*14 */
#define  RCC_CFGR_PLLMULL21                 ((uint32_t)0x10100000)        /*!< PLL input clock*15 */
#define  RCC_CFGR_PLLMULL22                 ((uint32_t)0x10140000)        /*!< PLL input clock*16 */
#define  RCC_CFGR_PLLMULL23                 ((uint32_t)0x10180000)        /*!< PLL input clock*16 */
#define  RCC_CFGR_PLLMULL24                 ((uint32_t)0x101C0000)        /*!< PLL input clock*16 */
#define  RCC_CFGR_PLLMULL25                 ((uint32_t)0x10200000)        /*!< PLL input clock*16 */
#define  RCC_CFGR_PLLMULL26                 ((uint32_t)0x10240000)        /*!< PLL input clock*16 */
#define  RCC_CFGR_PLLMULL27                 ((uint32_t)0x10280000)        /*!< PLL input clock*16 */
#define  RCC_CFGR_PLLMULL28                 ((uint32_t)0x102C0000)        /*!< PLL input clock*16 */
#define  RCC_CFGR_PLLMULL29                 ((uint32_t)0x10300000)        /*!< PLL input clock*16 */
#define  RCC_CFGR_PLLMULL30                 ((uint32_t)0x10340000)        /*!< PLL input clock*16 */
#define  RCC_CFGR_PLLMULL31                 ((uint32_t)0x10380000)        /*!< PLL input clock*16 */
#define  RCC_CFGR_PLLMULL32                 ((uint32_t)0x103C0000)        /*!< PLL input clock*16 */
